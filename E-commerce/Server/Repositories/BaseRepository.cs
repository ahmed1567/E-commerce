    ...
    where TEntity : BaseEntity
{
    ...
    public virtual async Task<IEnumerable<TEntity>> Get() => await _dbSet.ToListAsync() ?? Activator.CreateInstance<IEnumerable<TEntity>>();
    ...
    public virtual async Task Edit(TEntity Obj)
    {
